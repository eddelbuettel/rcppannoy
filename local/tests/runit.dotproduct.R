...
test03dist <- function() {
    ...
    checkEquals(a$getDistance(0, 1), 0 * 1 + 1 * 1,
...
test04dist2 <- function() {
    ...
    checkEquals(a$getDistance(0, 1), 1000 * 10 + 0 * 0, msg="distance 2")
}
...
test06degen <- function() {
    ...
    checkEquals(a$getDistance(0, 1), 0, msg="distance 4", tolerance=1.0e-6)
}
